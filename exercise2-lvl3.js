...
const countLove = (sentence1.match(/love/gi) || []).length; 
console.log(`The word 'love' appears ${countLove} times in the sentence.`);

// 2
const sentence2 = 'You cannot end a sentence with because because because is a conjunction';
const countBecause = (sentence2.match(/because/g) || []).length;
...
//       totalAnnualIncome += monthlyIncome * 12; // Convert monthly to annual
//     } else {
